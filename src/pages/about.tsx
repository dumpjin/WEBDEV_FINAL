      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          <Card className="bg-gradient-to-br from-zinc-900 to-black border border-red-900/30">
            ...
            <CardContent><p className="text-gray-400">Designed for high FPS, low latency, and reliable overclocking headroom.</p></CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-zinc-900 to-black border border-red-900/30">
            ...
            <CardContent><p className="text-gray-400">Bold aesthetics with customizable RGB and premium materials.</p></CardContent>
          </Card>
        </div>
      </section>

      <section className="max-w-7xl mx-auto px-6 py-12">
        <h3 className={`${montserrat.className} text-2xl font-bold mb-6`}>Partners and Achievements</h3>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-6 bg-gradient-to-br from-zinc-900 to-black border border-red-900/30 text-center">
            <Image src="/images/partner-nvidia.png" alt="NVIDIA" width={100} height={40} className="mx-auto mb-4" />
            <p className="text-gray-400">Official partner</p>
          </div>
          <div className="p-6 bg-gradient-to-br from-zinc-900 to-black border border-red-900/30 text-center">
            <Image src="/images/partner-amd.png" alt="AMD" width={100} height={40} className="mx-auto mb-4" />
            <p className="text-gray-400">Official partner</p>
          </div>
          <div className="p-6 bg-gradient-to-br from-zinc-900 to-black border border-red-900/30 text-center">
            <Image src="/images/partner-intel.png" alt="Intel" width={100} height={40} className="mx-auto mb-4" />
